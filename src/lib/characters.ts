...
export const CHARACTERS: Character[] = [
  {
    ...
    facts: [
      ...
      'Buddy the dog responds to 14 commands. Twelve of them were taught by Guy. None of them are the commands Pap and Mal taught.',
  ...
  },
  {
    ...
    origin: `Buddy arrived as a birthday surprise when Guy was six. Pap had wanted a goldfish. Mal had suggested a plant. Somehow they left the shelter with a four-month-old golden retriever who had already failed basic obedience twice and was described in his file as "enthusiastic beyond typical parameters."\n\nWithin 48 hours, Buddy had chewed through one shoe (Pap's, specifically), discovered that the kitchen bin was not actually secured, and learned to open the back door. The shelter had not mentioned the door thing.\n\nVet visits describe Buddy as "a healthy dog with an unusually strong sense of personal agency." Guy describes him as his best friend. Both are accurate.`,
    ...
    facts: [
      'Has three separate hiding spots for stolen socks. Pap has found two of them. Buddy knows Pap hasn\'t found the third.',
  ...
  },
  {
    ...
    origin: `Pap grew up as the responsible one. Middle child, never caused trouble, always handed homework in early, remembered to say thank you. He was, by all accounts, an excellent child. Teachers loved him. Neighbours trusted him with spare keys. His mum called him "the easy one."\n\nHe went to university, studied something sensible, got a job, bought a house. At no point in any of this did the universe give any indication of what was coming. He met Mal, they got married, they talked about having "a calm, organized household." This is funny now.\n\nPap owns one hat. A blue one. It goes everywhere with him and appears to be physically attached to his head by forces science cannot explain. Guy has tried to knock it off approximately 200 times. It has never fallen. This is the one area of his life where Pap has complete, unassailable dominance.`,
    relationship: `Pap chases Guy because that is the job now. He accepted this somewhere around Guy's fourth birthday and has been running ever since — literally and figuratively. He's not slow, exactly. He just has to find his keys first.\n\nDeep down, Pap knows that a lot of Guy's chaos comes from him. The curiosity, the problem-solving, the complete refusal to accept "because I said so" as a satisfying answer. He sees himself in it. He just can't say that out loud or Guy will use it as evidence.`,
    facts: [
      ...
      'Makes the same three dinners on rotation. Guy has memorized the schedule and uses it to plan activities during "pasta night" when Pap is distracted.',
